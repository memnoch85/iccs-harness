from session_memory_store import MemoryHit, SessionMemoryStore, format_memory_overlay
...
class SessionArchive:
    ...
    # this  is marked as potentially not having a caller (test-facing)
    ...
    # this has been marked as potentially not having a caller (currently test facing)
    def __len__(self):
