...
RESPONSE_ACK_NUM_PREDICT = int(
    os.getenv("NANCEE_RESPONSE_ACK_NUM_PREDICT", "18")
)
RESPONSE_ACK_TEMPERATURE = float(
    os.getenv("NANCEE_RESPONSE_ACK_TEMPERATURE", "0.25")
)
...
RESPONSE_NORMAL_NUM_PREDICT = int(
    os.getenv("NANCEE_RESPONSE_NORMAL_NUM_PREDICT", "36")
)
RESPONSE_NORMAL_TEMPERATURE = float(
    os.getenv("NANCEE_RESPONSE_NORMAL_TEMPERATURE", "0.30")
)

RESPONSE_DETAILED_NUM_PREDICT = int(
    os.getenv("NANCEE_RESPONSE_DETAILED_NUM_PREDICT", "65")
)
RESPONSE_DETAILED_TEMPERATURE = float(
    os.getenv("NANCEE_RESPONSE_DETAILED_TEMPERATURE", "0.30")
)

RESPONSE_RECALL_NUM_PREDICT = int(
    os.getenv("NANCEE_RESPONSE_RECALL_NUM_PREDICT", "18")
)
RESPONSE_RECALL_TEMPERATURE = float(
    os.getenv("NANCEE_RESPONSE_RECALL_TEMPERATURE", "0.15")
)
